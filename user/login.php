...
<body>
  ...
  <div class="module form-module">
    ...
    <a style=" display:flex ;text-align: center; align-items:flex-start; justify-content:flex-start;" href="forgotpassword.php">Forgot Password</a>
    <br>
   <a style=" display:flex ;text-align: center; align-items:flex-end; justify-content:flex-end; "href="../index.php">Back to Home</a>
