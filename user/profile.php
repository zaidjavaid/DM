...
<body>
  ...
  <div class="restsection">
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <input type="file" name="filename"style=" display:flex ;text-align: center; align-items:flex-end; justify-content:flex-end; margin-left:380px;"><br />

      <input type="submit" name="btn" class="btn btn-info" value="Upload" style=" display:flex ;text-align: center; align-items:flex-end; justify-content:flex-end; margin-left:380px;">
    </form>
    <?php
    ...
    ?>
    <br><br>
    <img src="<?php echo $img; ?> " style="width: 140px; display:flex ;text-align: center; align-items:flex-end; justify-content:flex-end;margin-left:350px;"
    class="img-circle">
    <br><br>
