...
<style type="text/css">
  ...
  body {
    ...
    background-image:url('https://www.mobiles24.com/static/previews/downloads/default/331/P-639049-3YtQsKhTZM-1.jpg');
  ...
  .form-module {
    ...
    border-top: 5px solid #54e8fe ;
    /* box-shadow: 0 0 3px rgba(0, 0, 0, 0.1); */
    box-shadow:inset -5px -5px rgba(109, 243, 251,0.7);
    margin: 0 auto;
    padding: 40px;
